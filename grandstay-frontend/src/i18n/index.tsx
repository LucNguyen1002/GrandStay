...
const messages = {
  vi: {
    ...
    'bookings.cancelDescription': 'Thao tác này sẽ giải phóng phòng đã giữ. Tiền cọc, nếu có, được xử lý theo chính sách hoàn tiền của khách sạn.',
  ...
  en: {
    ...
    'bookings.cancelDescription': 'This will release the reserved room. Any deposit will follow the hotel refund policy.',
