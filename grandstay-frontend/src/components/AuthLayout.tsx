  ...
  return <main className="relative grid min-h-screen overflow-hidden bg-ink lg:grid-cols-[1.1fr_.9fr]">
    <div className="login-hero relative hidden items-end overflow-hidden p-14 lg:flex">
      ...
      <div className="login-copy relative max-w-2xl pb-12">
        <div className="mb-7 inline-flex items-center gap-3 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-sm text-gold-soft backdrop-blur-sm"><BedDouble size={18}/> Vận hành tinh gọn, trải nghiệm trọn vẹn</div>
        <h1 className="font-sans text-6xl font-black leading-[1.08] tracking-[-0.04em] text-white">Mỗi kỳ nghỉ,<br/><span className="text-gold-soft">một dấu ấn.</span></h1>
        <p className="mt-6 max-w-lg text-lg leading-8 text-slate-300">Nền tảng điều hành tập trung cho lễ tân, buồng phòng, doanh thu và chăm sóc khách hàng.</p>
      </div>
    </div>
    <div className="flex items-center justify-center overflow-y-auto bg-cream px-5 py-10 sm:px-12">
